...
def train(hyp, opt, device, callbacks):
    ...
    if pretrained:
        ...
        # with torch_distributed_zero_first(LOCAL_RANK):                                #-------------------------------------此处被注释
            # weights = attempt_download(weights)  # download if not found locally      #-------------------------------------此处被注释
...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default=ROOT / "data/A12.yaml", help="dataset.yaml path")
